package com.berbas.hera.data

/**
 * FitnessDataController class is responsible for fetching and sending fitness data.
 * Additionally, it is responsible for processing the data such as clean up duplicates.
 *
 */
class FitnessDataController : DataController {
